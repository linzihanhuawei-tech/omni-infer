...
original_check_stop = utils.check_stop
...
def check_stop(request: Request, max_model_len: int) -> bool:
    ...
    if role != 'prefill': # decode节点上生效
        if not request.is_cot_end() and request.num_output_tokens >= reasoning_max_tokens:
    ...
    return original_check_stop(request,max_model_len)
